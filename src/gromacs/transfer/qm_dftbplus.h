...
#ifndef GMX_TRANSFER_QM_DFTBPLUS_H
#define GMX_TRANSFER_QM_DFTBPLUS_H
...
extern "C" void calcqmextpotgrad_transfer(void *refptr, gmx_unused double *q, double *extpotgrad);
