...
static void write_orca_input(gmx_unused const t_forcerec *fr, QMMM_QMrec& qm, QMMM_MMrec& mm)
{
    int        i;
 // t_QMMMrec *QMMMrec;
...
static real read_orca_output(rvec QMgrad[], rvec MMgrad[], gmx_unused const t_forcerec *fr,
...
real call_orca(const t_forcerec *fr,
               QMMM_QMrec& qm, QMMM_MMrec& mm, rvec f[], rvec fshift[])
{
    /* normal orca jobs */
    static int
        step = 0;
