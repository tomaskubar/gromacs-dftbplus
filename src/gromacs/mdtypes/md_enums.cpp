...
const char* enumValueToString(QMmethodType enumValue)
{
    static constexpr gmx::EnumerationArray<QMmethodType, const char*> QMmethodNames = {
        "AM1", "PM3", "RHF", "UHF", "DFT", "B3LYP", "MP2", "CASSCF", "B3LYPLAN", "DIRECT"
    };
    return QMmethodNames[enumValue];
}

const char* enumValueToString(QMbasisType enumValue)
{
    static constexpr gmx::EnumerationArray<QMbasisType, const char*> QMbasisNames = {
        "STO3G", "STO-3G", "3-21G", "3-21G*", "3-21+G*", "6-21G", "6-31G", "6-31G*", "6-31+G*", "6-311G"
    };
    return QMbasisNames[enumValue];
}
